...
# === 1. 讀完整資料 =========================================================
df_all = pd.read_csv("cab_data.csv")
df_all['datetime'] = pd.to_datetime(df_all['datetime'])

# === 2. 來源時間參數設定 (要複製哪一段原始資料) ================================
# start_time = pd.Timestamp("2025-04-11 12:05:00")
# end_time   = pd.Timestamp("2025-04-11 13:35:00")

start_time = pd.Timestamp("2025-04-14 10:49:00")
end_time   = pd.Timestamp("2025-04-14 11:45:00")
...
fault_specs = {
    ...
    # # 蒸發風扇 2026-01-01 10:00:00 至 2026-01-01 14:30:00
    ...
    # # 加熱器 2026-01-01 15:00:00 至 2026-01-01 17:48:00
...
# 設定模擬起始時間點
sim_start_base = pd.Timestamp("2026-01-01 15:00:00")
