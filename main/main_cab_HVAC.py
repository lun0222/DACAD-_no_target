...
# ==========================================
    ...
    try:
        ...
        if os.path.exists(predictions_csv):
            ...
            # --------------------------------------------------
                {'name': '冷凝盤管阻塞20%', 'len': 600},
                {'name': '冷凝盤管阻塞30%', 'len': 600},
                {'name': '蒸發盤管阻塞10%', 'len': 600},
                {'name': '蒸發盤管阻塞20%', 'len': 600},
                {'name': '蒸發盤管阻塞23%', 'len': 600},
                {'name': '正常資料常溫34度', 'len': 1800},
                {'name': '蒸發風扇電流90%', 'len': 600},
                {'name': '蒸發風扇電流80%', 'len': 600},
                {'name': '蒸發風扇電流70%', 'len': 600},
                {'name': '正常資料高溫42.7度', 'len': 600},
                {'name': '正常資料低溫24度', 'len': 1200},
                {'name': '冷媒洩漏10%', 'len': 1200},
                {'name': '冷媒洩漏20%', 'len': 1200},
                {'name': '正常資料低溫27度', 'len': 1200},
                {'name': '正常資料常溫30度', 'len': 1200},
                {'name': '輕度(兩層洗衣袋)冷凝盤管阻塞', 'len': 1020},
                {'name': '重度(四層洗衣袋)冷凝盤管阻塞', 'len': 600},
                {'name': '冷媒洩漏30%', 'len': 1200},
                {'name': '壓縮機故障10%', 'len': 1800},
                {'name': '壓縮機故障20%', 'len': 1800},
                {'name': '壓縮機故障30%', 'len': 1800},
                {'name': '冷凝風扇電流上升10%', 'len': 1800},
                {'name': '冷凝風扇電流上升20%', 'len': 1800},
                {'name': '冷凝風扇電流上升30%', 'len': 1800},
                {'name': '蒸發風扇電流上升10%', 'len': 1800},
                {'name': '蒸發風扇電流上升20%', 'len': 1800},
                {'name': '蒸發風扇電流上升30%', 'len': 1800},
            ]
