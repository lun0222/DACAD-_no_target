...
# --- 3. 定義資料集 ---
    ...
    # ('2025-04-14 10:49:01', '2025-04-14 11:30:00', 0), #加熱器運轉 訓練
    ...
    # ('2026-01-01 15:00:01', '2026-01-01 15:40:00', 0), #加熱器故障10% 訓練
    # ('2026-01-01 15:56:01', '2026-01-01 16:36:00', 0), #加熱器故障20% 訓練
    # ('2026-01-01 16:52:01', '2026-01-01 17:32:00', 0), #加熱器故障30% 訓練
    # ----------------------------------------------------------------
    # ('2025-04-11 09:34:01', '2025-04-11 09:44:00', 0), #冷凝盤管阻塞20% 測試
    # ('2025-04-11 10:06:01', '2025-04-11 10:16:00', 0), #冷凝盤管阻塞30% 測試
    # ('2025-04-11 10:49:01', '2025-04-11 10:59:00', 0), #蒸發盤管阻塞10% 測試
    # ('2025-04-11 11:21:01', '2025-04-11 11:31:00', 0), #蒸發盤管阻塞20% 測試
    # ('2025-04-11 11:53:01', '2025-04-11 12:03:00', 0), #蒸發盤管阻塞23% 測試
    # ('2025-04-11 13:05:01', '2025-04-11 13:35:00', 0), #正常資料常溫34度 測試
    # ('2025-04-11 14:05:01', '2025-04-11 14:15:00', 0), #蒸發風扇電流90% 測試
    # ('2025-04-11 14:39:01', '2025-04-11 14:49:00', 0), #蒸發風扇電流80% 測試
    # ('2025-04-11 15:12:01', '2025-04-11 15:22:00', 0), #蒸發風扇電流70% 測試
    # ('2025-04-11 16:06:01', '2025-04-11 16:16:00', 0), #正常資料高溫42.7度 測試
    # ('2025-04-14 09:40:01', '2025-04-14 10:00:00', 0), #正常資料低溫24度 測試
    # ('2025-04-14 11:30:01', '2025-04-14 11:45:00', 0), #加熱器運轉 測試
    # ('2025-04-14 14:05:01', '2025-04-14 14:25:00', 0), #冷媒洩漏10% 測試
    # ('2025-04-14 15:30:01', '2025-04-14 15:50:00', 0), #冷媒洩漏20% 測試
    # ('2025-12-23 11:03:01', '2025-12-23 11:23:00', 0), #正常資料低溫27度 測試
    # ('2025-12-23 12:55:01', '2025-12-23 13:15:00', 0), #正常資料常溫30度 測試
    # ('2025-12-23 13:40:01', '2025-12-23 13:57:00', 0), #輕度(兩層洗衣袋)冷凝盤管阻塞 測試
    # ('2025-12-23 14:23:01', '2025-12-23 14:33:00', 0), #重度(四層洗衣袋)冷凝盤管阻塞 測試
    # ('2025-12-23 15:40:01', '2025-12-23 16:00:00', 0), #冷媒洩漏30% 測試
    # ('2026-01-01 01:00:01', '2026-01-01 01:30:00', 0), #壓縮機故障10% 測試
    # ('2026-01-01 02:30:01', '2026-01-01 03:00:00', 0), #壓縮機故障20% 測試
    # ('2026-01-01 04:00:01', '2026-01-01 04:30:00', 0), #壓縮機故障30% 測試
    # ('2026-01-01 06:00:01', '2026-01-01 06:30:00', 0), #冷凝風扇電流上升10% 測試
    # ('2026-01-01 07:30:01', '2026-01-01 08:00:00', 0), #冷凝風扇電流上升20% 測試
    # ('2026-01-01 09:00:01', '2026-01-01 09:30:00', 0), #冷凝風扇電流上升30% 測試
    # ('2026-01-01 11:00:01', '2026-01-01 11:30:00', 0), #蒸發風扇電流上升10% 測試
    # ('2026-01-01 12:30:01', '2026-01-01 13:00:00', 0), #蒸發風扇電流上升20% 測試
    # ('2026-01-01 14:00:01', '2026-01-01 14:30:00', 0), #蒸發風扇電流上升30% 測試
    # ('2026-01-01 15:40:01', '2026-01-01 15:56:00', 0), #加熱器故障10% 測試
    # ('2026-01-01 16:36:01', '2026-01-01 16:52:00', 0), #加熱器故障20% 測試
    # ('2026-01-01 17:32:01', '2026-01-01 17:48:00', 0), #加熱器故障30% 測試
...
# -----------------------------------------------------------------------------------
    ('2025-04-11 09:14:01', '2025-04-11 09:34:00', 1), #冷凝盤管阻塞20% 訓練
    ('2025-04-11 09:46:01', '2025-04-11 10:06:00', 1), #冷凝盤管阻塞30% 訓練
    ('2025-04-11 10:29:01', '2025-04-11 10:49:00', 0), #蒸發盤管阻塞10% 訓練
    ('2025-04-11 11:01:01', '2025-04-11 11:21:00', 0), #蒸發盤管阻塞20% 訓練
    ('2025-04-11 11:33:01', '2025-04-11 11:53:00', 0), #蒸發盤管阻塞23% 訓練
    ('2025-04-11 12:05:01', '2025-04-11 13:05:00', 0), #正常資料常溫34度 訓練
    ...
    ('2025-12-23 10:23:01', '2025-12-23 11:03:00', 0), #正常資料低溫27度 訓練
    ('2025-12-23 12:15:01', '2025-12-23 12:55:00', 0), #正常資料常溫30度 訓練
    ('2025-12-23 13:19:01', '2025-12-23 13:40:00', 1), #輕度(兩層洗衣袋)冷凝盤管阻塞 訓練
    ('2025-12-23 14:03:01', '2025-12-23 14:23:00', 1), #重度(四層洗衣袋)冷凝盤管阻塞 訓練
    ('2025-12-23 15:00:01', '2025-12-23 15:40:00', 0), #冷媒洩漏30% 訓練
    ('2026-01-01 00:00:01', '2026-01-01 01:00:00', 0), #壓縮機故障10% 訓練
    ('2026-01-01 01:30:01', '2026-01-01 02:30:00', 0), #壓縮機故障20% 訓練
    ('2026-01-01 03:00:01', '2026-01-01 04:00:00', 0), #壓縮機故障30% 訓練
...
test_time_periods = [
    ...
    # ('2026-01-01 11:30:01', '2026-01-01 13:00:00',0),#蒸發風扇電流上升20%
    # -----------------------------------------------------------
    ('2025-04-11 09:34:01', '2025-04-11 09:44:00', 1), #冷凝盤管阻塞20% 測試
    ('2025-04-11 10:06:01', '2025-04-11 10:16:00', 1), #冷凝盤管阻塞30% 測試
    ('2025-04-11 10:49:01', '2025-04-11 10:59:00', 0), #蒸發盤管阻塞10% 測試
    ('2025-04-11 11:21:01', '2025-04-11 11:31:00', 0), #蒸發盤管阻塞20% 測試
    ('2025-04-11 11:53:01', '2025-04-11 12:03:00', 0), #蒸發盤管阻塞23% 測試
    ('2025-04-11 13:05:01', '2025-04-11 13:35:00', 0), #正常資料常溫34度 測試
    ...
    ('2025-12-23 11:03:01', '2025-12-23 11:23:00', 0), #正常資料低溫27度 測試
    ('2025-12-23 12:55:01', '2025-12-23 13:15:00', 0), #正常資料常溫30度 測試
    ('2025-12-23 13:40:01', '2025-12-23 13:57:00', 1), #輕度(兩層洗衣袋)冷凝盤管阻塞 測試
    ('2025-12-23 14:23:01', '2025-12-23 14:33:00', 1), #重度(四層洗衣袋)冷凝盤管阻塞 測試
    ('2025-12-23 15:40:01', '2025-12-23 16:00:00', 0), #冷媒洩漏30% 測試
    ('2026-01-01 01:00:01', '2026-01-01 01:30:00', 0), #壓縮機故障10% 測試
    ('2026-01-01 02:30:01', '2026-01-01 03:00:00', 0), #壓縮機故障20% 測試
    ('2026-01-01 04:00:01', '2026-01-01 04:30:00', 0), #壓縮機故障30% 測試
