...
# -----------------------------------------------------------------------------------
    ...
    ('2025-12-23 14:03:01', '2025-12-23 14:23:00', 0), #重度(四層洗衣袋)冷凝盤管阻塞 訓練
    ('2025-12-23 15:00:01', '2025-12-23 15:40:00', 0), #冷媒洩漏30% 訓練
    ('2026-01-01 00:00:01', '2026-01-01 01:00:00', 1), #壓縮機故障10% 訓練
    ('2026-01-01 01:30:01', '2026-01-01 02:30:00', 1), #壓縮機故障20% 訓練
    ('2026-01-01 03:00:01', '2026-01-01 04:00:00', 1), #壓縮機故障30% 訓練
    ('2026-01-01 05:00:01', '2026-01-01 06:00:00', 0), #冷凝風扇電流上升10% 訓練
    ('2026-01-01 06:30:01', '2026-01-01 07:30:00', 0), #冷凝風扇電流上升20% 訓練
    ('2026-01-01 08:00:01', '2026-01-01 09:00:00', 0), #冷凝風扇電流上升30% 訓練
    ('2026-01-01 10:00:01', '2026-01-01 11:00:00', 0), #蒸發風扇電流上升10% 訓練
...
test_time_periods = [
    ...
    ('2025-12-23 14:23:01', '2025-12-23 14:33:00', 0), #重度(四層洗衣袋)冷凝盤管阻塞 測試
    ('2025-12-23 15:40:01', '2025-12-23 16:00:00', 0), #冷媒洩漏30% 測試
    ('2026-01-01 01:00:01', '2026-01-01 01:30:00', 1), #壓縮機故障10% 測試
    ('2026-01-01 02:30:01', '2026-01-01 03:00:00', 1), #壓縮機故障20% 測試
    ('2026-01-01 04:00:01', '2026-01-01 04:30:00', 1), #壓縮機故障30% 測試
    ('2026-01-01 06:00:01', '2026-01-01 06:30:00', 0), #冷凝風扇電流上升10% 測試
    ('2026-01-01 07:30:01', '2026-01-01 08:00:00', 0), #冷凝風扇電流上升20% 測試
    ('2026-01-01 09:00:01', '2026-01-01 09:30:00', 0), #冷凝風扇電流上升30% 測試
    ('2026-01-01 11:00:01', '2026-01-01 11:30:00', 0), #蒸發風扇電流上升10% 測試
